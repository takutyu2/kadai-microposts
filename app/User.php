                                    ...
                                    CanResetPasswordContract
{
    ...
    public function do_favorite($micropostId) {
        $exist = $this->done_favorite($micropostId);
    ...
    public function do_unfavorite($micropostId) {
        $exist = $this->done_favorite($micropostId);
        $its_me = $this->id == $micropostId;
    ...
    public function done_favorite($micropostId) {
